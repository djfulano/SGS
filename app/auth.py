...
MODULES = [
    ...
    ("cancelamentos_sites", "Cancelamento de Sites"),
    ("cancelamentos_consulta", "Cancelamento de Sites > Consulta"),
    ("cancelamentos_editar", "Cancelamento de Sites > Editar processos"),
    ("cancelamentos_concluir", "Cancelamento de Sites > Concluir processos"),
