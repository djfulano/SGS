...
MODULES = [
    ("resumo_superior", "Resumo superior"),
    ("sites", "Topologia"),
    ...
    ("ranking", "Ranking"),
    ("custos_receita", "Custos x receita"),
    ("sites_deficitarios", "Sites Deficitários"),
    ("sites_documentos", "Sites x Documentos"),
    ("predios", "Prédios"),
    ("mapa", "Mapa"),
    ("produtos", "Produtos"),
    ("sva", "SVA"),
    ("equipamentos_por_site", "Equipamentos por Site"),
    ("buscar_equipamentos", "Buscar equipamentos"),
    ("base_equipamentos", "Editar Equipamentos"),
    ("retirada", "Retirada"),
    ("enlaces", "Enlaces"),
    ("sem_vinculo", "Sem vínculo"),
    ("sites_sem_clientes", "Sites sem clientes na base"),
    ("sites_removidos", "Sites removidos"),
    ("clientes_cancelados", "Clientes cancelados"),
    ("clientes_snmpc_cancelados", "Clientes no SNMPc cancelado"),
    ...
    ("editar_contatos_sites", "Editar contatos dos sites"),
    ("editar_contratos_sites", "Editar documentos dos sites"),
    ("importar_dados", "Executar importações"),
    ("editar_configuracoes", "Editar configurações"),
    ("editar_base_equipamentos", "Editar base de equipamentos"),
    ("editar_produtos", "Editar produtos"),
    ("visualizar_valores_clientes", "Visualizar valores dos clientes"),
    ("visualizar_valores_custos", "Visualizar valores de custos"),
    ("copiar_tabelas", "Copiar tabelas")
]
