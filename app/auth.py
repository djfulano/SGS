...
MODULES = [
    ...
    ("enlaces", "Ferramentas > Enlaces"),
    ("equipamentos_por_site", "Ferramentas > Equipamentos por Site"),
    ("buscar_equipamentos", "Ferramentas > Buscar Equipamentos"),
    ("base_equipamentos", "Ferramentas > Editar Equipamentos"),
    ("editar_base_equipamentos", "Ferramentas > Editar Base de Equipamentos"),
    ("suporte", "Suporte"),
