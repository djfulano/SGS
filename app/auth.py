...
MODULES = [
    ...
    ("gestao_viabilidades", "Gestão de Viabilidades"),
    ("gestao_viabilidades_dashboard", "Gestão de Viabilidades > Dashboard"),
    ("gestao_viabilidades_consulta", "Gestão de Viabilidades > Consulta"),
    ("gestao_viabilidades_importar", "Gestão de Viabilidades > Importação"),
