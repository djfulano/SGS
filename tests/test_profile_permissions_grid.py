...
class ProfilePermissionsGridTest(unittest.TestCase):
    ...
    def test_permissoes_de_suporte_e_equipamentos_ficam_em_grupos_corretos(self):
        ...
        self.assertEqual(
            grupos_por_chave["viabilidade_oportunidades_site"],
            "Viabilidade"
        )
        self.assertEqual(
            grupos_por_chave["financeiro_historico_site"],
            "Financeiro"
        )
        self.assertEqual(
            grupos_por_chave["financeiro_prioridades"],
            "Financeiro"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            grupos_por_chave["financeiro_alertas_criticos"],
            "Financeiro"
        )
        self.assertEqual(
            grupos_por_chave["clientes_custos_sites"],
            "Clientes"
        )
        self.assertEqual(
